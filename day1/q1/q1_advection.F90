program q1_advection
  ...
  write(*,*) "1=FTCS", "; 2=FTBS", "; 3=Lax" 
  write(*,*) "4=Lax-Wendroff", "; 5=Beam-warming", "; 6=Mac-Cormak"
  read(*,*) scheme
  ...
  open(unit=20, file="scheme_"//trim(adjustl(scheme_name))//"_f90.dat", form="formatted")
  do i = 1, n+1
    write(20,*) (i-1)*dx, f(i)
  end do
  close(20)
